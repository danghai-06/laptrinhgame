...
public:
    ...
    PlayerTank() : x(0), y(0), dirX(0), dirY(-1) {
        rect = {x, y, TILE_SIZE, TILE_SIZE};
    }
        ...
        while(SDL_PollEvent(&event)) {
            if(event.type == SDL_QUIT) {
                ...
                switch(event.key.keysym.sym) {
                    ...
                    case SDLK_w: player.move(0, -5, walls); break;
                    case SDLK_s: player.move(0, 5, walls); break;
                    case SDLK_a: player.move(-5, 0, walls); break;
                    case SDLK_d: player.move(5, 0, walls); break;
